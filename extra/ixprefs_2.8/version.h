...
#ifdef TRACE_LIBRARY
#define IX_IDSTRING     "ixemul 49.20 [trace, 68000, soft-float, amigaos] (8.8.2005)"
#else
#define IX_IDSTRING     "ixemul 49.20 [68000, soft-float, amigaos] (8.8.2005)"
#endif
#define IX_VERSION      49
#define IX_REVISION     20
